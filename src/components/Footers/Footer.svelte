  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
              ...
              <div class="grid grid-cols-2 ">
                <div class="">
                  <ul class="mt-4 space-y-4">
                    {#each treatments.slice(0, 4) as treatment}
                      <li>
                        <a
                          use:link
                ...
                <ul class="mt-4 space-y-4">
                  {#each treatments.slice(4, 9) as treatment}
                    <li>
                      <a
                        use:link
                        href="treatments/{treatment.link[`${$lang}`]}"
        ...
        <div class=" mt-10 lg:mt-0 md:grid md:grid-cols-1 ">
          <div>
            <h3
              class="text-sm font-semibold text-white tracking-wider uppercase"
            >
              {$Translate("contact_BIG")}
            </h3>

            <div class="">
              <p class=" pt-5 text-md tracking-tight text-gray-200">
                <a href="tel:{general.branch1Tel[`${$lang}`]}">
                  {general.branch1Tel[`${$lang}`]}
                </a>
              </p>
              <p class=" pt-5 text-md tracking-tight text-gray-200 ">
                <a href="mailto:{general.email[`${$lang}`]}">
                  {general.email[`${$lang}`]}</a
                >
              </p>
              <p class=" pt-5 text-md tracking-tight text-gray-200 ">
    ...
    >
      <div class="flex space-x-6 md:order-2">
        <a
          use:link
          href="tel:{general.branch1Tel[`${$lang}`]}"
          target="_blank"
